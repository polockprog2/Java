...
public class Start
{
	public static void main (String args[]) throws Exception
	{
		...
		while (repeat)
		{
			...
			System.out.println("\t4. Product Quantity Management.");
			...
			switch(choice)
			{
				case 1:
					...
					switch(option1)
					{
						...
						case 2:
                            ...
                            Employee e2 = mrkt.searchEmployee(empId2);
                            
                            if(e2 != null)
							{
								if(mrkt.removeEmployee(e2))
								{
						...
						case 4:
							...
							Employee e3 = mrkt.searchEmployee(empId3);
				...
				case 2:
					...
					switch(option2)
					{
						...
						case 2:
                            ...
                            Shop s2 = mrkt.searchShop(sid2);
                            
                            if(s2 != null)
							{
								if(mrkt.removeShop(s2))
								{
				...
				case 3:
					...
					switch(option3)
					{
						case 1:
							...
							if(mrkt.searchShop(sid1)!=null)
							{
								...
								if(Type == 1)
								{
									...
									if(mrkt.searchShop(sid1).insertProduct(lp1))
									{
								...
								else if(Type == 2)
								{
									...
									if(mrkt.searchShop(sid1).insertProduct(ip1))
									{
										System.out.println("Product Name  "+pm1+"  inserted for  Shop  ID  "+sid1);
										System.out.println("=========================");
									}
					    ...
					    case 2:
							...
							if(mrkt.searchShop(sid4)!=null)
							{
								System.out.print("Enter Product ID : ");
								String pid2=sc.next();
								if(mrkt.searchShop(sid4).searchProduct(pid2)!=null)
								{
									System.out.print("Enter ID to Remove Product.");
									String pid3= sc.next();
									
									Product p4 = mrkt.searchShop(sid4).searchProduct(pid2);
									if(mrkt.searchShop(sid4).removeProduct(p4))
									{
						...
						case 4:
							...
							if(sid5!=null)
							{
							    ...
							    Product p3 = mrkt.searchShop(sid5).searchProduct(pid4);
				...
				case 4:
					System.out.println("=========================");
					System.out.println("You Have Chosen Product Quantity management.");
					System.out.println("=========================");
					...
					switch(option4)
					{
						case 1: 
							...
							if(mrkt.searchShop(sid1) != null)
							{
								...
								if(mrkt.searchShop(sid1).searchProduct(pid1) != null)
								{
									System.out.print("Enter Amount to Add : ");
									int am1 = sc.nextInt();
									
									if(mrkt.searchShop(sid1).searchProduct(pid1).addQauntity(am1))
									{
										System.out.println("=========================");
						...
						case 2:
							...
							if(mrkt.searchShop(sid6) != null)
							{
								System.out.print("Enter  Product ID : ");
								String pid1 = sc.next();
								
								if(mrkt.searchShop(sid6).searchProduct(pid1) != null)
								{
									System.out.print("Enter Amount to Sell : ");
									int am2 = sc.nextInt();
									
									if(mrkt.searchShop(sid6).searchProduct(pid1).sellQuantity(am2))
									{
										System.out.println("=========================");
